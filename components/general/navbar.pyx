    ...
    if menu_open:
        mobile_menu = (
            <div className="md:hidden bg-gray-800 border-t border-gray-700 px-6 py-4 space-y-3">
                <a href="#home" className="block text-gray-300 hover:text-white text-sm py-1">Home (Latest Posts)</a>
        ...
        <nav className="fixed top-0 w-full bg-gray-900 z-50 shadow-lg">
            <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <ul className="hidden md:flex space-x-6 list-none m-0 p-0">
                    <li><a href="#home" className="text-gray-300 hover:text-white text-sm transition-colors">Home (Latest Posts)</a></li>
